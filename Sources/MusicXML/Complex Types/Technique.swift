...
public enum Technique {
    case arrow(Arrow)
    case bend(Bend)
    case doubleTongue(PlacementPrintStyle = PlacementPrintStyle())
    case downBow(PlacementPrintStyle = PlacementPrintStyle())
    case fingering(Fingering = Fingering())
    case fingernails(PlacementPrintStyle = PlacementPrintStyle())
    case fret(Fret = Fret())
    case hammerOn(HammerOnPullOff)
    case handbell(Handbell)
    case harmonic(Harmonic)
    case heel(HeelToe)
    case openString(PlacementPrintStyle = PlacementPrintStyle())
    case otherTechnical(PlacementText)
    case pluck(PlacementText = PlacementText())
    case pullOff(HammerOnPullOff)
    case snapPizzicato(PlacementPrintStyle = PlacementPrintStyle())
    case stopped(PlacementPrintStyle = PlacementPrintStyle())
    case string(MusicXML.String = MusicXML.String())
    case tap(PlacementText)
    case thumbPosition(PlacementPrintStyle = PlacementPrintStyle())
    case toe(HeelToe)
    case tripleTongue(PlacementPrintStyle = PlacementPrintStyle())
