...
public func encode(to encoder: Encoder) throws {
    ...
    try container.encode(value, forKey: .value)
    try container.encodeIfPresent(number, forKey: .number)
    try container.encodeIfPresent(YesNo(repeater), forKey: .repeater)
...
public func encode(to encoder: Encoder) throws {
    var container = encoder.container(keyedBy: CodingKeys.self)
    try container.encodeIfPresent(placement, forKey: .placement)
    try container.encodeIfPresent(YesNo(directive), forKey: .directive)
...
public func encode(to encoder: Encoder) throws {
    ...
    try container.encodeIfPresent(placement, forKey: .placement)
    try container.encodeIfPresent(YesNo(printObject), forKey: .printObject)
    try container.encodeIfPresent(YesNo(printFrame), forKey: .printFrame)
    try printStyle.encode(to: encoder)
...
public func encode(to encoder: Encoder) throws {
    ...
    try container.encode(number, forKey: .number)
    try container.encodeIfPresent(text, forKey: .text)
    try container.encodeIfPresent(YesNo(implicit), forKey: .implicit)
    try container.encodeIfPresent(YesNo(nonControlling), forKey: .nonControlling)
    try container.encodeIfPresent(width, forKey: .width)
...
public func encode(to encoder: Encoder) throws {
    var container = encoder.container(keyedBy: CodingKeys.self)
    try container.encode(value, forKey: .value)
    try container.encodeIfPresent(YesNo(sound), forKey: .sound)
}
// sourcery:end
...
public func encode(to encoder: Encoder) throws {
    ...
    try container.encodeIfPresent(YesNo(time), forKey: .time)
    try container.encodeIfPresent(editorial, forKey: .editorial)
}
// sourcery:end
...
public func encode(to encoder: Encoder) throws {
    ...
    try printStyleAlign.encode(to: encoder)
    try container.encode(type, forKey: .type)
    try container.encodeIfPresent(YesNo(line), forKey: .line)
    try container.encodeIfPresent(YesNo(sign), forKey: .sign)
}
// sourcery:end
...
public func encode(to encoder: Encoder) throws {
    ...
    try container.encodeIfPresent(YesNo(newSystem), forKey: .newSystem)
    try container.encodeIfPresent(YesNo(newPage), forKey: .newPage)
...
public func encode(to encoder: Encoder) throws {
    var container = encoder.container(keyedBy: CodingKeys.self)
    try container.encodeIfPresent(YesNo(measure), forKey: .measure)
...
public func encode(to encoder: Encoder) throws {
    var container = encoder.container(keyedBy: CodingKeys.self)
    try container.encode(type, forKey: .type)
    try container.encodeIfPresent(YesNo(useDots), forKey: .useDots)
    try container.encodeIfPresent(YesNo(useStems), forKey: .useStems)
...
public func encode(to encoder: Encoder) throws {
    ...
    try container.encodeIfPresent(dynamics, forKey: .dynamics)
    try container.encodeIfPresent(YesNo(dacapo), forKey: .dacapo)
    ...
    try container.encodeIfPresent(divisions, forKey: .divisions)
    try container.encodeIfPresent(YesNo(forwardRepeat), forKey: .forwardRepeat)
...
public init(from decoder: Decoder) throws {
    ...
    topSystemDistance = try container.decodeIfPresent(Tenths.self, forKey: .topSystemDistance)
...
public func encode(to encoder: Encoder) throws {
    ...
    try container.encodeIfPresent(YesNo(double), forKey: .double)
}
// sourcery:end
